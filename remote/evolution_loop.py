...
class EvolutionLoop:
    ...
    def set_regression_gate(self, gate_fn):
    ...
    def rollback(self, to_version_id: Optional[str] = None) -> bool:
        ...
        with self.lock:
            ...
            # Execute rollback hooks: only undo improvements introduced
