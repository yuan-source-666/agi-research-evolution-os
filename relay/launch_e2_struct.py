#!/usr/bin/env python3
"""上传 phase_e2_struct.py，等 E1 (PID 7259) 跑完后自动启动结构自进化。"""
...
LOCAL = r"E:\ai_agent_workspace\teleagent\.temp\scnet_v8\phase_e2_struct.py"
REMOTE = "/root/private_data/phase_e2_struct.py"
E1_PID = "7259"
...
print("== launch (waits for E1 pid %s) ==" % E1_PID)
code = (
    "import subprocess, os\n"
    "wrapper = ('while kill -0 " + E1_PID + " 2>/dev/null; do sleep 30; done; "
    "sleep 30; cd /root/private_data && python3 phase_e2_struct.py "
    "> phase_e2_struct.log 2>&1')\n"
    "log = open('/root/private_data/phase_e2_struct_wrapper.log', 'w')\n"
    "p = subprocess.Popen(['bash', '-c', wrapper], stdout=log,\n"
    "                     stderr=subprocess.STDOUT, start_new_session=True)\n"
    "print('wrapper pid', p.pid)")
print(run_code(code))
print("log: /root/private_data/phase_e2_struct.log")
print("result: /root/private_data/phase_e2_struct.json")
